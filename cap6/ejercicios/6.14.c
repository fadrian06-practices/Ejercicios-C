/*
  Modifique el programa de la figura 6.16 para que la función moda sea capaz de
  manipular un empate para el valor de la moda. Además, modifique la función
  mediana de manera que los dos elementos centrales sean promediados en un
  arreglo con un número par de elementos.
 */

/* Figura 6.16: fig06_16_1.c
...
void media(const int resp[]) {
  ...
  int total = 0; /* variable para mantener
